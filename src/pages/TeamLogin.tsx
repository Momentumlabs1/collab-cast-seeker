    ...
    try {
      ...
      if (error || !data) {
        toast({
          ...
          description: "Der eingegebene Zugangscode ist nicht gültig.",
          variant: "destructive",
        });
        setLoading(false);
        return;
      ...
      if (!data.is_active) {
        toast({
          ...
          description: "Dein Zugang wurde deaktiviert. Kontaktiere den Admin.",
          variant: "destructive",
        });
        setLoading(false);
        return;
      ...
      toast({
        title: `Willkommen, ${data.name}!`,
        description: "Du wirst zum Workflow-Dashboard weitergeleitet.",
      });
      ...
      >
        ...
        <div className="bg-[hsl(0,0%,7%)] border border-[hsl(0,0%,13%)] rounded-2xl p-8 shadow-2xl">
          ...
          <p className="text-center text-[hsl(0,0%,55%)] mb-8">
            Gib deinen Zugangscode ein, um auf das<br />Workflow-Tool zuzugreifen.
          </p>
