...
const LandingPage = () => {
  ...
  return <div className="min-h-screen bg-background overflow-hidden">
        ...
        <div className="relative z-10 text-center max-w-4xl mx-auto">
          ...
          delay: 0.1
            ...
            <span className="relative inline-block">
              ...
              duration: 1,
              delay: 0.8
            }} className="absolute -bottom-2 left-0 w-full" viewBox="0 0 400 20" fill="none">
                <motion.path d="M2 15 Q 200 -5, 398 15" stroke="currentColor" strokeWidth="3" strokeLinecap="round" fill="none" />
              </motion.svg>
            </span>
          </motion.h1>
          ...
          delay: 0.3
            ...
            <Button variant="hero" size="xl" onClick={() => navigate("/apply")} className="group">
              Apply Now
      ...
      <section className="py-24 bg-muted/30 px-0">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {accounts.map((account, index) => <motion.button key={account.name} onClick={() => setSelectedAccount(account)} initial={{
            opacity: 0,
            y: 30
          }} whileInView={{
            opacity: 1,
            ...
            delay: index * 0.1
          }} className={`group bg-background p-6 rounded-2xl border-2 transition-all duration-300 hover:shadow-xl text-left ${account.highlight ? "border-foreground ring-2 ring-foreground/20" : "border-border hover:border-foreground/50"}`}>
                <div className="flex items-start justify-between mb-4">
                  <div className="flex items-center gap-3">
                    <div className={`w-12 h-12 rounded-xl flex items-center justify-center ${account.highlight ? "bg-foreground text-background" : "bg-muted text-foreground"}`}>
                  ...
                  <span className={`px-3 py-1 text-xs font-medium rounded-full ${account.highlight ? "bg-foreground text-background" : "bg-muted"}`}>
                    {account.tag}
                  </span>
                </div>
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-2">
                    ...
                    {account.platforms.length > 1 && <span className="text-xs text-muted-foreground">
              ...
              {selectedAccount && <>
                  <DialogHeader>
                    <div className="flex items-center gap-4 mb-2">
                      <div className={`w-14 h-14 rounded-xl flex items-center justify-center ${selectedAccount.highlight ? "bg-foreground text-background" : "bg-muted text-foreground"}`}>
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="flex flex-wrap items-center gap-3">
                      <span className={`px-3 py-1 text-sm font-medium rounded-full ${selectedAccount.highlight ? "bg-foreground text-background" : "bg-muted"}`}>
                        {selectedAccount.tag}
                      </span>
                      <span className="px-3 py-1 text-sm font-semibold rounded-full bg-primary/10 text-primary">
                        {selectedAccount.pay}
                      </span>
                      {selectedAccount.platforms.map(platform => <span key={platform} className="px-3 py-1 text-xs rounded-full bg-muted text-muted-foreground">
                          {platform}
                        </span>)}
                    </div>
                    ...
                    <div>
                      ...
                      <ul className="space-y-2">
                        {selectedAccount.requirements.map((req, i) => <li key={i} className="flex items-start gap-3">
                    ...
                    navigate("/apply");
                      ...
                      <Button variant="outline" className="flex-1" onClick={() => window.open(selectedAccount.link, "_blank")}>
          ...
          once: true
            ...
            <a href="https://www.tiktok.com/@yeti_dyor" target="_blank" rel="noopener noreferrer" className="text-foreground underline hover:no-underline">
              @yeti_dyor on TikTok
            </a>
          </motion.p>
        </div>
      ...
      <section className="py-24 px-6">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-8">
            ...
            step: "01",
            title: "Apply",
            desc: "Submit your portfolio and tell us about yourself"
          }, {
            step: "02",
            title: "Training",
            desc: "Free teaching phase to learn our style"
          }, {
            step: "03",
            title: "Selection",
            desc: "Multiple rounds – we pick the best talent"
          }, {
            step: "04",
            title: "Get Paid",
          ...
          once: true
            ...
            <div className="flex flex-col sm:flex-row items-center gap-6 sm:gap-8">
              ...
              <div className="text-center sm:text-left flex-1">
                ...
                <Button variant="hero" size="lg" onClick={() => setReferralOpen(true)} className="gap-2">
      ...
      <section className="py-24 px-6 bg-foreground text-background">
        <div className="max-w-4xl mx-auto text-center">
          ...
          delay: 0.2
            ...
            <Button variant="outline" size="xl" onClick={() => navigate("/apply")} className="bg-background text-foreground hover:bg-background/90 border-background">
